<template>
	<view>
		...
		<uni-card :title="data.name" :subTitle="data.id" extra="在线" note="Tips" thumbnail="/static/icons/plugin.svg">
		...
		<uni-list>
			<uni-list-item title="编辑插件" link :to="'./edit?id='+id">
				<template v-slot:header>
					<uni-icons class="list-icon" customPrefix="iconfont" type="icon-pen"></uni-icons>
				</template>
			</uni-list-item>
			<uni-list-item title="删除插件" @click="remove" :clickable="true">
				<template v-slot:header>
